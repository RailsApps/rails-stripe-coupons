...
Rails 5.0 example application demonstrates how to sell a product using "Stripe.js":https://stripe.com/docs/stripe.js. Use this example application as a starter app for your own web applications.
