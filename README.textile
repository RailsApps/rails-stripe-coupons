h1. !http://railsapps.github.io/images/rails-36x36.jpg(Stripe JS With Coupons)! Stripe JS With Coupons

Rails 4.2 example application demonstrates how to sell a product using "Stripe.js":https://stripe.com/docs/stripe.js. Use this example application as a starter app for your own web applications.
...
"Stripe.js":https://stripe.com/docs/stripe.js is optimal for use with a Rails application, allowing full customization of a payment form and integration with Rails form processing. The rails-stripe-coupon application implements a payment feature using Stripe JS so a visitor pays to download a PDF file. The application accommodates promotional coupons and adds payment forms to landing pages, for real-world payment processing.
...
* provide coupons for promotional discounts or free downloads

In addition to covering coupons, free downloads, landing pages, and background processing, the tutorial shows how to refactor the application, illustrating an application architecture favored by experienced Rails developers.

h2. What Is Not Here

This application does not provide a shopping cart for purchasing multiple products with a single transaction. It also doesn’t provide recurring billing for a subscription site.
...
<pre>
$ git clone git://github.com/RailsApps/rails-stripe-coupons.git
</pre>
...
<pre>
$ rails new rails-stripe-coupons -m https://raw.github.com/RailsApps/rails-composer/master/composer.rb
</pre>

The @$@ character indicates a shell prompt; don't include it when you run the command.

This creates a new Rails app named @rails-stripe-coupons@ on your computer. You can use a different name if you wish.
...
Choose *rails-stripe-coupons*. The Rails Composer tool may give you other options (other applications may have been added since these notes were written).
...
@CreateAdminService@ is a service object that obtains @admin_email@ and @admin_password@ values from the *config/secrets.yml* file. You can examine the file *app/services/create_admin_service.rb* to see how a new user is created. @CreateCouponcodesService@ is a service object that creates coupons.
...
You should see a home page with a navigation bar. Click "Sign Up" or "Purchase."
...
You’ll be redirected to the home page and see a message “Welcome! You have signed up successfully.” You’ll be logged in as a new user. You’ll be able to download a PDF file for the ebook you’ve purchased.
...
Problems? Check the "issues":https://github.com/RailsApps/rails-stripe-coupons/issues.

h2. Issues

Please create a "GitHub issue":https://github.com/RailsApps/rails-stripe-coupons/issues if you identify any problems or have suggestions for improvements.
...
Send the author a message, create an "issue":https://github.com/RailsApps/rails-stripe-coupons/issues, or fork the project and submit a pull request.
